...
#   hubot jenkins d(escribe) <job> - Describes the specified Jenkins job
...
module.exports = (robot) ->
  ...
  robot.respond /([\w\.\-_ ]+) (\s*)빌드/i, (msg) ->
    jenkinsBuild(msg, false)

  robot.respond /([\w\.\-_ ]+) (\s*)배포/i, (msg) ->
    msg.match[1] = "deploy_" + msg.match[1]
    jenkinsBuild(msg, false)
  ...
  robot.respond /j(?:enkins)? d(?:escribe)? (.*)/i, (msg) ->
    jenkinsDescribe(msg)

  robot.respond /([\w\.\-_ ]+) (\s*)상태/i, (msg) ->
    jenkinsDescribe(msg)
